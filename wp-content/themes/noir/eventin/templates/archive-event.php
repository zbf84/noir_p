...
<div class="main-event-archive pt-100 pb-100 ddd">
    ...
    <div class="etn-event-archive-wrap etn_search_item_container" data-json='<?php echo json_encode([
        "error_content" => [
            "title" => esc_html__('Nothing found!', 'noir'),
            "exerpt" => esc_html__('It looks like nothing was found here. Maybe try a search?','noir')
        ]
    ]); ?>'>
        <div class="etn-container">
            ...
            if (have_posts()) {
                ...
                while (have_posts()) {
                    ...
                    ?>
                <div
                    class="etn-col-md-6 etn-col-lg-<?php echo esc_attr( apply_filters( 'etn_event_archive_column', '4' ) ); ?>">
                ...
                ?>
                <p><?php echo esc_html('No Event found!', 'noir'); ?></p>
                <?php
            }
            ?>
