<?php
    ...
    $author_info = get_the_author_meta( 'eduker_write_by');
    $facebook_url = get_the_author_meta( 'eduker_facebook' );
    $twitter_url = get_the_author_meta( 'eduker_twitter' );
    $linkedin_url = get_the_author_meta( 'eduker_linkedin' );
    $instagram_url = get_the_author_meta( 'eduker_instagram' );
    $eduker_url = get_the_author_meta( 'eduker_youtube' );
    $eduker_write_by = get_the_author_meta( 'eduker_write_by' );
